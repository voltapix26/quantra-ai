...
const CACHE = 'quantra-v56';
const SHELL = [
  '/', '/index.html', '/terminal.html', '/discover.html', '/portfolio.html', '/calendar.html',
  '/styles.css?v=59', '/onboard.js?v=1', '/analysis.js', '/auth.js', '/terminal.js', '/pwa.js', '/hero.js', '/i18n.js',
